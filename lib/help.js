...
export const helpText = `
  <div class='text-info block'>
    ...
    <tr>
      ...
      <td>Go to next page (or <span class="keyIcon">&#8671;</span>
          or <span class="keyIcon">SPACE</span>)</td>
    </tr>
    <tr>
      <td><span class="keyIcon">${cmdKey}</span><span class="keyIcon">${cmd2Key}</span><span class="keyIcon">&larr;</span></td>
      <td>Go to previous page (or <span class="keyIcon">&#8670;</span>
          or <span class="keyIcon">${shiftKey}</span><span class="keyIcon">SPACE</span>)</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Go to last page (or <span class="keyIcon">HOME</span>)</td>
    </tr>
    </table>
    <table>
      <h3 class='text-highlight'>Zooming/Display</h3>
      <tr>
        <td><span class="keyIcon">${cmdKey}</span><span class="keyIcon">+</span>, <span class="keyIcon">${cmdKey}</span><span class="keyIcon">–</span></td>
        <td>Zoom notation in/out (or <span class="keyIcon">${cmdKey}</span><span class="keyIcon">Mouse wheel</span>)</td>
      </tr>
      <tr>
        <td><span class="keyIcon">${cmdKey}</span><span class="keyIcon">0</span>, <span class="keyIcon">${cmdKey}</span><span class="keyIcon">5</span></td>
        <td>Zoom to 100%, 50%, respectively</td>
      </tr>
      <tr>
        <td><span class="keyIcon">Q</span></td>
        <td>Invert notation colors</td>
      </tr>
    </table>
    <table>
  ...
  <div class='text-info block'>
    <table>
      <tr>
        <td><span class="keyIcon">O</span></td>
        <td>Insert octave shift above (8va), spanning two selected notes/chords (below with CTRL)</td>
      </tr>
      <tr>
        <td><span class="keyIcon">${altKey}</span><span class="keyIcon">O</span></td>
        <td>Insert octave shift above (15va), spanning two selected notes/chords (below ith CTRL)</td>
      </tr>
      <tr>
        <td><span class="keyIcon">B</span></td>
        <td>Insert beam on selected notes/chords sharing identical parent</td>
      </tr>
    </table>
  </div>
  ...
  <div class='text-info block'>
    ...
    <tr>
      ...
      <td>Invert att.placement (dir, dynam, trill, tuplet number, ...),
  ...
  <div class='text-info block'>
    ...
    <tr>
      <td><span class="keyIcon">&#8679;</span><span class="keyIcon">&uarr;</span></td>
      <td>Move note, rest, mRest, multiRest one tone upwards </td>
    </tr>
    <tr>
      <td><span class="keyIcon">&#8679;</span><span class="keyIcon">&darr;</span></td>
      <td>Move note, rest, mRest, multiRest one tone downwards</td>
    </tr>
    <tr>
      <td><span class="keyIcon">${cmdKey}</span><span class="keyIcon">&#8679;</span><span class="keyIcon">&uarr;</span></td>
      <td>Move note, rest, mRest, multiRest one octave upwards </td>
    </tr>
    <tr>
      <td><span class="keyIcon">${cmdKey}</span><span class="keyIcon">&#8679;</span><span class="keyIcon">&darr;</span></td>
      <td>Move note, rest, mRest, multiRest one octave downwards</td>
    </tr>
    <tr>
      <td><span class="keyIcon">${altKey}</span><span class="keyIcon">${cmdKey}</span><span class="keyIcon">&uarr;</span></td>
      <td>Move note, rest, mRest, multiRest one staff downwards </td>
    </tr>
    <tr>
      <td><span class="keyIcon">${altKey}</span><span class="keyIcon">${cmdKey}</span><span class="keyIcon">&darr;</span></td>
      <td>Move note, rest, mRest, multiRest one staff upwards</td>
    </tr>
    </table>
  </div>
  ...
  <h3 class="text-highlight">Deleting elements</h3>
    ...
    <tr>
      ...
      <td>Delete control elements, clef change, accid, artic, beam</td>
    </tr>
    </table>
  </div>
