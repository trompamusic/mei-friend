  ...
  */
  ...
  addControlElement(textEditor, elementName = 'slur', placementString = '', formString = '') {
    if (this.selectedElements.length <= 2 && this.selectedElements.length > 0) {
      ...
      if (this.selectedElements.length == 1 && (elementName == 'slur' || elementName == 'tie' || elementName == 'hairpin')) {
      ...
      elementString = '<' + elementName + ' xml:id="' + uuid + '" ';
      // with always two ids
      if (elementName == 'slur' || elementName == 'tie' || elementName == 'hairpin') {
        elementString += 'startid="#' + startId + '" endid="#' + endId + '" ';
      } else if (elementName == 'fermata' || elementName == 'dir' || elementName == 'dynam' || elementName == 'tempo') { // only one id
        elementString += 'startid="#' + startId + '" ';
      }
      // possibly a second id, only if existing
      if (endId != '' && (elementName == 'dir' || elementName == 'dynam')) {
        elementString += 'endid="#' + endId + '" ';
      }
      // add form
      if (elementName == 'hairpin' || elementName == 'fermata') {
        elementString += 'form="' + formString + '" ';
      }
      // add placement
      if (placementString != '') elementString += 'place="' + placementString + '" ';
      if (elementName == 'dir' || elementName == 'dynam' || elementName == 'tempo') {
        elementString += '>' + formString + '</' + elementName + '>';
      } else {
        elementString += '/>';
      }
      ...
      textEditor.insertText(elementString);
      ...
      if (range) {
        ...
        console.info('addControlElement() added: "' + elementString + '"');
  ...
  createHTMLElements(scale) {
    ...
    this.decreaseBtn.setAttribute('value', 'decreaseScale');
    ...
    this.increaseBtn.innerHTML = '<span class="icon icon-diff-added"></span>';
    this.increaseBtn.setAttribute('type', 'button');
    this.increaseBtn.setAttribute('value', 'increaseScale');
    this.zoomCtrls.appendChild(this.increaseBtn);


    // Highlight color controls
    // this.colorCtrls = document.createElement('div');
    // this.colorCtrls.id = 'color-ctrls';
    // this.controlsForm.appendChild(this.colorCtrls);
    //
    // const hlghtLabel = document.createElement('label');
    // hlghtLabel.innerText = 'Highlight Color:';
    // this.colorCtrls.appendChild(hlghtLabel);
    ...
    // this.colorCtrls.appendChild(this.hlghtCtrl);
    ...
    this.codeUpdateBtn.innerHTML = 'Update';
    ...
    this.debugCtrls = document.createElement('div');
    this.debugCtrls.id = 'debug-ctrls';
    this.controlsForm.appendChild(this.debugCtrls);

    debugLabel = document.createElement('label');
    debugLabel.innerText = 'Debug: ';
    this.debugCtrls.appendChild(debugLabel);
    ...
    this.debugCtrls.appendChild(this.debugBtn);
    ...
    this.debugCtrls.appendChild(this.xBtn);

    this.verovioBtn = document.createElement('button');
    this.verovioBtn.id = "verovio-btn";
    this.verovioBtn.innerHTML = '<span class="icon icon-repo-sync"></span>';
    this.verovioBtn.setAttribute('type', 'button');
    this.verovioBtn.setAttribute('value', 'debug');
    this.debugCtrls.appendChild(this.verovioBtn);

    this.backwardsBtn = document.createElement('button');
    this.backwardsBtn.id = "backwards-btn";
    this.backwardsBtn.innerHTML = '<span class="icon icon-arrow-left"></span>';
    this.backwardsBtn.setAttribute('type', 'button');
    this.backwardsBtn.setAttribute('value', 'debug');
    this.debugCtrls.appendChild(this.backwardsBtn);

    this.forwardsBtn = document.createElement('button');
    this.forwardsBtn.id = "forwards-btn";
    this.forwardsBtn.innerHTML = '<span class="icon icon-arrow-right"></span>';
    this.forwardsBtn.setAttribute('type', 'button');
    this.forwardsBtn.setAttribute('value', 'debug');
    this.debugCtrls.appendChild(this.forwardsBtn);
