  ...
  */
  ...
  invertPlacement(textEditor, id) {
    ...
    try {
      ...
      console.error('invertPlacement() ERROR: ', exception);
    }
    // console.log('vrvToolkit.getLog(): ', this.vrvToolkit.getLog());
    // console.info('invertPlacement: ' + JSON.stringify(this.vrvToolkit.getElementAttr(id)));
    textEditor.setText(this.vrvToolkit.getMEI());
