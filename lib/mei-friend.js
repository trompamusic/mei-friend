...
export default {
  ...
  activateSubscriptions(vrvToolkit) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'mei-friend:firstPage': () => this.mFV.updatePage(this.editor, 'first', true),
      'mei-friend:lastPage': () => this.mFV.updatePage(this.editor, 'last', true),
      ...
      'mei-friend:supplyElement': () => this.mFV.supplyElement(this.editor),
      'mei-friend:supplyArtic': () => this.mFV.supplyAttribute(this.editor, 'artic'),
      'mei-friend:supplyAccid': () => this.mFV.supplyAttribute(this.editor, 'accid'),
      'mei-friend:pianoDynamicsBetween': () => this.mFV.pianoDynamicsBetween(this.editor),
    }));
