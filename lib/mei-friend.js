...
export default {
  ...
  activateSubscriptions(vrvToolkit) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'mei-friend:nextPage': () => this.meiFriendView.updatePage(this.activeEditor, 'next'),
      'mei-friend:previousPage': () => {
        ...
        if (notesOnPanel > 0) {
          ...
          this.meiFriendView.updatePage(this.activeEditor, 'prev');
        }
      },
      ...
      'mei-friend:addSlur': () => this.meiFriendView.addSlur(this.activeEditor),
      'mei-friend:addTie': () => this.meiFriendView.addTie(this.activeEditor),
      'mei-friend:addCresHairpin': () => this.meiFriendView.addSlur(this.activeEditor),
      'mei-friend:addDimHairpin': () => this.meiFriendView.addTie(this.activeEditor),
