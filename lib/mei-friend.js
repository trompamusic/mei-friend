...
export default {
  ...
  activateSubscriptions(vrvToolkit) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'mei-friend:zoomIn': () => this.meiFriendView.zoom(this.activeEditor, +1),
      'mei-friend:zoomOut': () => this.meiFriendView.zoom(this.activeEditor, -1),
      'mei-friend:zoom50': () => this.meiFriendView.zoom(this.activeEditor, 50),
      'mei-friend:zoom100': () => this.meiFriendView.zoom(this.activeEditor, 100),
      ...
      'mei-friend:firstPage': () => this.meiFriendView.updatePage(this.activeEditor, 'first', true),
      'mei-friend:lastPage': () => this.meiFriendView.updatePage(this.activeEditor, 'last', true),
      ...
      'mei-friend:addBeam': () => this.meiFriendView.addBeamElement(this.activeEditor, 'beam'),
      'mei-friend:addOctave8Above': () => this.meiFriendView.addOctaveElement(this.activeEditor, 'above', 8),
      'mei-friend:addOctave8Below': () => this.meiFriendView.addOctaveElement(this.activeEditor, 'below', 8),
      'mei-friend:addOctave15Above': () => this.meiFriendView.addOctaveElement(this.activeEditor, 'above', 15),
      'mei-friend:addOctave15Below': () => this.meiFriendView.addOctaveElement(this.activeEditor, 'below', 15)
    }));
