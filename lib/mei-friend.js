...
export default {
  ...
  activateSubscriptions(vrvToolkit) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'mei-friend:nextPage': () => this.meiFriendView.updatePage(this.activeEditor, 'forwards', true),
      'mei-friend:previousPage': () => {
        if (domutils.isFirstElementOnPage(this.meiFriendView.lastNoteId)) // turn page
          this.meiFriendView.updatePage(this.activeEditor, 'backwards', true);
