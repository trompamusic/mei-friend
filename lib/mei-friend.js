...
=======
=======
>>>>>>> ed858b2862ddc1004663b559b6f44e157ca6d57c
  vrvWorker: null,
...
=======
    ...
    this.handleFirstWorkerEvent = this.handleFirstWorkerEvent.bind(this);

    this.vrvWorker = new Worker(path.resolve(__dirname, 'worker.js'));

    this.vrvWorker.onmessage = this.handleFirstWorkerEvent;

    // ask worker to load Verovio
    this.vrvWorker.postMessage({
      'cmd': 'loadVerovio',
      'msg': 'Please load Verovio.'
    });
<<<<<<< HEAD
<<<<<<< HEAD
...
>>>>>>> First worker steps
=======
>>>>>>> more worker functionalities
=======
>>>>>>> ed858b2862ddc1004663b559b6f44e157ca6d57c
  },

  handleFirstWorkerEvent(e) {
    console.log('handleFirstWorkerEvent(). Worker said: ', e.data);
    switch (e.data.cmd) {
      case 'vrvLoaded':
  ...
  activateSubscriptions(worker) {
    this.vrvWorker = worker;
    ...
    this.meiFriendView = new MeiFriendView(this.vrvWorker);
...
>>>>>>> ed858b2862ddc1004663b559b6f44e157ca6d57c
  ...
  deserializeMeiFriendView({currentPage}) {
    return null; // new MeiFriendView(this.vrvWorker, currentPage); // null
  },
