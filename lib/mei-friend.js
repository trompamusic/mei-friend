...
export default {
  ...
  activateSubscriptions(vrvToolkit) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'mei-friend:invertPlacement': () => this.meiFriendView.invertPlacement(this.activeEditor, this.meiFriendView.selectedElements[0]),
  ...
  deserializeMeiFriendView({
    ...
    return null; // new MeiFriendView(vrvToolkit);
  },
