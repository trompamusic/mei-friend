...
export function getPageFromDom(xmlDoc, pageNo = 1, whichBreaks = ['sb', 'pb']) {
  ...
  // quick fix for Verovio 3.5 bug #2358
  baseSection.appendChild(document.createElementNS(meiNameSpace, 'sb'));
  ...
  return function digDeeper(section) {
    ...
    if (p > pageNo) {
      ...
      if (!m) {
        ...
        // quick fix for Verovio 3.5 bug #2358
        sec.appendChild(document.createElementNS(meiNameSpace, 'sb'));
