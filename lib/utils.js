...
export function getIdOfNextElement(textBuffer, rw,
  ...
  if (uuid) {
    ...
    //startStaffN + '; OrigLayer=' + startLayerN;
...
export function getIdOfNextSvgElement(currentElement, direction = 'forwards',
  ...
  let startLayerN = currentElement.closest('.layer').getAttribute('data-n');
  let startStaffN = currentElement.closest('.staff').getAttribute('data-n');
  ...
  for (i of elementList) {
    if (found &&
      i.closest('.layer').getAttribute('data-n') == startLayerN &&
      i.closest('.staff').getAttribute('data-n') == startStaffN) {
      ...
      if (incr == 'measure') {
        ...
        if (direction == 'backwards') // to find first element of measure
          return currentMeasure // TODO ATTENTION: leak ahead!!!
            .querySelector('.staff[data-n="' + startStaffN + '"]')
            .querySelector('.layer[data-n="' + startLayerN + '"]')
            .querySelector(elementNames)
            .getAttribute('id');
      }
